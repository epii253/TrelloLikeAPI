...
async def test_create_board(client, team_name: str):
...
@pytest.mark.parametrize(
    ...
    [("DevOps", "CSHAR"), ("ARCHVM", "YANDEX_ITMO"), ("DiscreteMath", "Algo_coloq")]
) 
async def test_get_team_boards(client, board_name: str, board_name2: str):
    member_name: str = "alice"
    alice_response = await client.post(
        "/auth/register",
        json={
